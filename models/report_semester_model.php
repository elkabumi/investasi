...
function select_detail($i_master_category_id, $i_master_sub_category_id, $i_semester, $i_master_year, $country,$city,$busines,$tenaga1,$tenaga2,$investasi1,$investasi2, $sub_busines){
	$parameter = "";
	...
	if($i_semester == '1'){
		$where = " AND DATE_FORMAT( master_date, '%m' ) BETWEEN 1 AND 6 ";
		
	}else if($i_semester == '2'){
		$where = " AND DATE_FORMAT( master_date, '%m' ) BETWEEN 7 AND 12 ";
	}
