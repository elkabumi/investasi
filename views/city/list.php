                                           ...
                                           $no = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['city_desc']?></td>
                                                 ...
                                                 <a href="city.php?page=form&id=<?= $row['city_id']?>" class="btn btn-default" ><i class="fa fa-pencil"></i></a>
                                                 
                                                <a href="javascript:void(0)" onclick="confirm_delete(<?= $row['city_id']; ?>,'city.php?page=delete&id=')" class="btn btn-default" ><i class="fa fa-trash-o"></i></a>
                                             </td>
                                            </tr>
                                            <?php
											$no++;
