                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                       ...
                                       ?>
                                            ...
                                            <td><?= $no_item ?></td>
                                            	...
                                            	<td><a href="edit_transaction.php?page=form_edit&id=<?=$id?>&date1=<?=$date1?>&date2=<?=$date2?>&owner=<?=$owner_id?>&id_trans=<?= $row_item['transaction_id']?>" class="btn btn-default" ><i class="fa fa-pencil"></i></a></td>
                                          ...
                                          <tfoot>
                                            <tr>
                                                <th colspan="10"><a href="<?= $close_button ?>" class="btn btn-default" >Close</a></th>
