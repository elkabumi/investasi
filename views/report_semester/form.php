...
function show_sub(str)
{
	...
	xmlhttp.open("GET","../views/report_semester/sub_form.php?id="+str,true);
	xmlhttp.send();
	}
</script>
                ...
                <section class="content">
                    ...
                    <div class="box-footer">
                                <input class="btn btn-cokelat" type="submit" value="Preview"/>
                             	 <?php if(isset($_GET['preview'])){ ?><a href="<?= "report_semester.php?page=form_download&master_category_id=$i_master_category_id&master_sub_category_id=$i_master_sub_category_id&semester=".$i_semester."&master_year=$i_master_year&country=$country&city=$city&busines=$busines&tenaga=".$_GET['tenaga']."&investasi=".$_GET['investasi']."&sub_busines=$sub_busines"; ?>" class="btn btn-cokelat" >Download Excel</a>
								 <a href="<?= "report_semester.php?page=download_pdf&master_category_id=$i_master_category_id&master_sub_category_id=$i_master_sub_category_id&semester=".$i_semester."&master_year=$i_master_year&country=$country&city=$city&busines=$busines&tenaga=".$_GET['tenaga']."&investasi=".$_GET['investasi']."&sub_busines=$sub_busines"; ?>" class="btn btn-cokelat" >Download PDF</a>
								 <?php } ?>
                                </div>
