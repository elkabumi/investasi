                ...
                <section class="content">
                    ...
                    <div class="box-footer">
                                <input class="btn btn-default" type="submit" value="Preview"/>
                             	 <?php if(isset($_GET['preview'])){ ?><a href="report_detail.php?page=download&date=<?= $_GET['date']?>&owner=<?= $_GET['owner']?>" class="btn btn-default" >Download Excel</a>
								 <a href="report_detail.php?page=download_pdf&date=<?= $_GET['date']?>&owner=<?= $_GET['owner']?>" class="btn btn-default" >Download PDF</a>
								 <?php } ?>
                                </div>
