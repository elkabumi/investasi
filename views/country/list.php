                                           ...
                                           $no = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['country_description']?></td>
                                                 ...
                                                 <a href="country.php?page=form&id=<?= $row['country_id']?>" class="btn btn-default" ><i class="fa fa-pencil"></i></a>
                                                 
                                                <a href="javascript:void(0)" onclick="confirm_delete(<?= $row['country_id']; ?>,'country.php?page=delete&id=')" class="btn btn-default" ><i class="fa fa-trash-o"></i></a>
                                             </td>
                                            </tr>
                                            <?php
											$no++;
