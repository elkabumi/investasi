                ...
                <section class="content">
                    ...
                    <div class="box-footer">
                                <input class="btn btn-cokelat" type="submit" value="Preview"/>
                             	 <?php if(isset($_GET['preview'])){ ?><a href="<?= "report_tahunan.php?page=form_download&master_category_id=$i_master_category_id&master_sub_category_id=$i_master_sub_category_id&master_year1=".$i_master_year1."&master_year2=$i_master_year2&country=$country&city=$city&busines=$busines&tenaga=".$_GET['tenaga']."&investasi=".$_GET['investasi']."&sub_busines=$sub_busines"; ?>" class="btn btn-cokelat" >Download Excel</a>
								 <a href="<?= "report_tahunan.php?page=download_pdf&master_category_id=$i_master_category_id&master_sub_category_id=$i_master_sub_category_id&master_year1=".$i_master_year1."&master_year2=$i_master_year2&country=$country&city=$city&busines=$busines&tenaga=".$_GET['tenaga']."&investasi=".$_GET['investasi']."&sub_busines=$sub_busines"; ?>" class="btn btn-cokelat" >Download PDF</a>
								 <?php } ?>
                                </div>
