...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" style="font-size:32px; font-weight:bold;" colspan="<?= $colspan_aktif ?>">Laporan Semester <?= $nama_category ?> </td>
  </tr>
  <tr>
    <td align="center" style="font-size:22px; font-weight:bold;"  colspan="<?= $colspan_aktif ?>"><?= "Semester ".$i_semester." - ".$i_master_year; ?></td>
  </tr>
</table>
