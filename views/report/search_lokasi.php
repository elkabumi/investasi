                                       ...
                                       <?
										...
										?>
                                          <?
												...
												$pekerja=pekerja($row['city_id'],0,$i_master_sub_category_id,$i_master_year);
												$investasi=investasi($row['city_id'],0,$i_master_sub_category_id,$i_master_year);
												
												$jumlah=jumlah($row['city_id'],0,$i_master_sub_category_id,$i_master_year);
										?>
                                  		 <td><?=$jumlah?></td>
                                         <td><?=$investasi?></td>
                                         <td><?=$pekerja?></td>
										...
										?>
                                          <?
												...
												$pekerja=pekerja(0,0,$i_master_sub_category_id,$i_master_year);
												$investasi=investasi(0,0,$i_master_sub_category_id,$i_master_year);
												
												$jumlah=jumlah(0,0,$i_master_sub_category_id,$i_master_year);
										?>
                                  		 <td><?=$jumlah?></td>
                                         <td><?=$investasi?></td>
                                         <td><?=$pekerja?></td>
