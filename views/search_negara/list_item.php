      ...
      <thead>
        <tr>
                                       ...
                                       <?
												...
												$awal = $akhir -  2;
                                                for($i_bulan = $awal; $i_bulan <= $akhir; $i_bulan++){
												$pekerja=pekerja($row['country_id'],$i_bulan,$i_master_sub_category_id,$i_master_year);
												$investasi=investasi($row['country_id'],$i_bulan,$i_master_sub_category_id,$i_master_year);
												
												$jumlah=jumlah($row['country_id'],$i_bulan,$i_master_sub_category_id,$i_master_year);
										?>
                                         <td><?=$jumlah?></td>
                                         <td><?=$investasi?></td>
                                         <td><?=$pekerja?></td>
